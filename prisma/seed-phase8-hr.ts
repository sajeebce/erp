  ...
  const jobPostings = await Promise.all([
    prisma.jobPosting.create({
      data: {
        ...
        minExperience: 5,
        requiredSkills: ['WASH', 'project-management', 'donor-reporting', 'M&E', 'team-management'],
        requiredLanguages: [{ language: 'English', level: 'Fluent' }, { language: 'Bangla', level: 'Native' }],
    ...
    prisma.jobPosting.create({
      data: {
        ...
        minExperience: 2,
        requiredSkills: ['field-work', 'data-collection', 'community-mobilization', 'report-writing'],
        requiredLanguages: [{ language: 'Bangla', level: 'Native' }, { language: 'English', level: 'Working' }],
    ...
    prisma.jobPosting.create({
      data: {
        ...
        minEducation: 'MASTERS',
        minExperience: 3,
        requiredSkills: ['financial-management', 'donor-compliance', 'audit', 'grant-management'],
